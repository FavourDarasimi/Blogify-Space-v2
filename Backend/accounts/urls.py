...
urlpatterns = [
    path('refresh/', views.RefreshTokenView.as_view(), name='refresh_token'),    path('signup/',views.SignUpView.as_view(),name='signup'),
    path('login/',views.LoginView.as_view(),name='login'),
    path('get_user/',views.GetUserView.as_view(),name='get_user'),
    path('is-Authenticated/',views.Is_Authenticated.as_view(),name='is_Authenticated'),
