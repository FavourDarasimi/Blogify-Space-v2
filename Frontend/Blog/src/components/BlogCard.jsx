...
const BlogCard = ({ post }) => {
  if (post.featured) {
    return (
      <div className="group relative overflow-hidden rounded-2xl cursor-pointer transition-all duration-300 hover:shadow-xl md:col-span-2 md:row-span-2">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-8 md:p-10">
          ...
          <div className="text-white space-y-3">
            <h3 className="text-3xl md:text-4xl font-bold leading-tight font-serif">
              {post.title}
            </h3>
